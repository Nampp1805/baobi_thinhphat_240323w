        ...
        <div class="row">
                ...
                <div class="card card-primary card-outline text-sm">
                    ...
                    <?php if(isset($config['static'][$type]['video']) && $config['static'][$type]['video'] == true) { ?>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control text-sm" name="data[video]" id="video" onchange="youtubePreview(this.value,'#loadVideo');" placeholder="Video" value="<?=(!empty($flash->has('video'))) ? $flash->get('video') : @$item['video']?>">
                        </div>
                        <div class="form-group">
                                    ...
                                    <div class="tab-content" id="custom-tabs-three-tabContent-lang">
                                        <?php foreach($config['website']['lang'] as $k => $v) { ?>
                                            <div class="tab-pane fade show <?=($k=='vi')?'active':''?>" id="tabs-lang-<?=$k?>" role="tabpanel" aria-labelledby="tabs-lang">
                                                ...
                                                <?php } ?>
                                                <?php if(isset($config['static'][$type]['slogan1']) && $config['static'][$type]['slogan1'] == true) { ?>
                                                    <div class="form-group">
                                                        <label for="slogan1<?=$k?>">Slogan 1 (<?=$k?>):</label>
                                                        <input type="text" class="form-control text-sm" name="data[slogan1<?=$k?>]" id="slogan1<?=$k?>" placeholder="Slogan 1 (<?=$k?>)" value="<?=(!empty($flash->has('slogan1'.$k))) ? $flash->get('slogan1'.$k) : @$item['slogan1'.$k]?>" >
                                                    </div>
                                                <?php } ?>
            ...
            <div class="<?=$colRight?>">
                ...
                <?php if(isset($config['static'][$type]['images1']) && $config['static'][$type]['images1'] == true) { ?>
                    <div class="card card-primary card-outline text-sm">
                        <div class="card-header">
                            <h3 class="card-title">Hình ảnh 1 <?=$config['static'][$type]['title_main']?></h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
                            </div>
                        </div>
