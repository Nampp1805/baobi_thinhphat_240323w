<?php
	$linkMan = "index.php?com=places&act=man_ward&type=".$_REQUEST['type'];
	if($act=='add_ward') $linkFilter = "index.php?com=places&act=add_ward&type=".$_REQUEST['type'];
	else if($act=='edit_ward') $linkFilter = "index.php?com=places&act=edit_ward&type=".$_REQUEST['type']."&id=".$id;
    $linkSave = "index.php?com=places&act=save_ward&type=".$_REQUEST['type'];
?>
<!-- Content Header -->
        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
				...
				<div class="form-group">
					<label for="namevi">Tiêu đề: <span class="text-danger">*</span></label>
					<input type="text" class="form-control text-sm" name="data[namevi]" id="namevi" placeholder="Tiêu đề" value="<?=(!empty($flash->has('namevi'))) ? $flash->get('namevi') : @$item['namevi']?>" required>
				</div>
