<?php
	$linkMan = $linkFilter = "index.php?com=places&act=man_ward&type=".$_REQUEST['type'];
    $linkAdd = "index.php?com=places&act=add_ward&type=".$_REQUEST['type'];
	$linkEdit = "index.php?com=places&act=edit_ward&type=".$_REQUEST['type'];
	$linkDelete = "index.php?com=places&act=delete_ward&type=".$_REQUEST['type'];
?>
<!-- Content Header -->
