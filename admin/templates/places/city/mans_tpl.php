<?php
    ...
    $linkAdd = "index.php?com=places&act=add_city&type=".$_REQUEST['type'];
	$linkEdit = "index.php?com=places&act=edit_city&type=".$_REQUEST['type'];
	$linkDelete = "index.php?com=places&act=delete_city&type=".$_REQUEST['type'];
?>
<!-- Content Header -->
