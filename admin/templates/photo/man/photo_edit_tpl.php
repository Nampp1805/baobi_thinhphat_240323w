                    ...
                    <div class="form-group">
                        <div class="upload-file">
                            ...
                            <label class="upload-file-label mb-2" for="file">
                                ...
                                <?php $arr_duoi = explode('.', $item['photo']);
                                      $duoifile = $arr_duoi[1];
                                      if($duoifile=='mp4'){ ?> 
                                    <video class="slide-video slide-media" loop muted preload="metadata" autoplay="" width="400px">
                                      <source src="<?=UPLOAD_PHOTO.@$item['photo']?>" type="video/mp4" />
                                    </video> 
                                    <?php } else { ?> 
