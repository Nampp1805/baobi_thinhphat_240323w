...
<section class="content">
    <div class="row">
        ...
        <div class="col-12 col-sm-6 col-md-4">
            <div class="info-box mb-3">
                <span class="info-box-icon bg-warning elevation-1"><i class="fas fa-check-circle" style="color: #fff;"></i></span>
                <div class="info-box-content">
                    <span class="info-box-text text-warning font-weight-bold text-capitalize text-sm">Đang giao hàng</span>
                    <p class="info-box-text text-sm mb-0">Số lượng: <span class="text-danger font-weight-bold"><?=$allSendOrder?></span></p>
                    <p class="info-box-text text-sm mb-0">Tổng giá: <span class="text-danger font-weight-bold"><?=$func->formatMoney($totalSendOrder)?></span></p>
                </div>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4">
