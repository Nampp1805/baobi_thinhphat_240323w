        ...
        <div class="row">
            ...
            <div class="<?= $colRight ?>">
                ...
                <?php if (isset($config['news'][$type]['images1']) && $config['news'][$type]['images1'] == true) { ?>
                    <div class="card card-primary card-outline text-sm">
                        <div class="card-header">
                            <h3 class="card-title">Hình ảnh 1 <?= $config['news'][$type]['title_main'] ?></h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            $photoDetail1['dimension'] = "Width: " . $config['news'][$type]['width1'] . " px - Height: " . $config['news'][$type]['height1'] . " px (" . $config['news'][$type]['img_type'] . ")";
                ...
                <?php if (isset($config['news'][$type]['images2']) && $config['news'][$type]['images2'] == true) { ?>
                    <div class="card card-primary card-outline text-sm">
                        ...
                        <div class="card-body">
                            ...
                            $photoDetail2['dimension'] = "Width: " . $config['news'][$type]['width2'] . " px - Height: " . $config['news'][$type]['height2'] . " px (" . $config['news'][$type]['img_type'] . ")";
        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                <?php if (isset($config['news'][$type]['link']) && $config['news'][$type]['link'] == true) { ?>
                    ...
                    <div class="form-group col-md-6">
                        <label class="d-block" for="phone">Số điện thoại:</label>
                        <input type="text" class="form-control text-sm" name="data[phone]" id="phone" placeholder="phone" value="<?= (!empty($flash->has('phone'))) ? $flash->get('phone') : @$item['phone'] ?>">
                    </div>
                <?php } ?>
                <div class="form-group">
