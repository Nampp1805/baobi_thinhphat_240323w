...
<section class="content">
    <form class="validation-form" novalidate method="post" action="<?=$linkSave?>" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="<?=$colRight?>">
                <?php if(isset($config['product'][$type]['images_list1']) && $config['product'][$type]['images_list1'] == true) { ?>
                    <div class="card card-primary card-outline text-sm">
                        <div class="card-header">
                            <h3 class="card-title">Hình ảnh icon</h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
                            </div>
                        </div>
                        <div class="card-body">
                            <?php
                                ...
                                $photoDetail1['thumb'] = $config['product'][$type]['thumb_list1'];
                                $photoDetail1['dimension'] = "Width: ".$config['product'][$type]['width_list1']." px - Height: ".$config['product'][$type]['height_list1']." px (".$config['product'][$type]['img_type_list'].")";
                ...
                <?php if(isset($config['product'][$type]['images_list2']) && $config['product'][$type]['images_list2'] == true) { ?>
                    <div class="card card-primary card-outline text-sm">
                        <div class="card-header">
                            <h3 class="card-title">Hình ảnh icon hover</h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
                            </div>
                        </div>
                        <div class="card-body">
                            <?php
                                ...
                                $photoDetail2['thumb'] = $config['product'][$type]['thumb_list2'];
                                $photoDetail2['dimension'] = "Width: ".$config['product'][$type]['width_list2']." px - Height: ".$config['product'][$type]['height_list2']." px (".$config['product'][$type]['img_type_list'].")";
