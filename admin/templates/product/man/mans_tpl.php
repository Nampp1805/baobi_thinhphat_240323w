    ...
    <?php if(
	    ...
	    <div class="card-footer form-group-category text-sm bg-light row">
			<?php if(isset($config['product'][$type]['list']) && $config['product'][$type]['list'] == true) { ?>
				<div class="form-group col-xl-2 col-lg-3 col-md-4 col-sm-4 mb-2"><p class="mb-1"><?=$config['product'][$type]['title_main_list']?></p><?=$func->getLinkCategory('product', 'list', $type)?></div>
			<?php } ?>
			<?php if(isset($config['product'][$type]['cat']) && $config['product'][$type]['cat'] == true) { ?>
				<div class="form-group col-xl-2 col-lg-3 col-md-4 col-sm-4 mb-2"><p class="mb-1"><?=$config['product'][$type]['title_main_cat']?></p><?=$func->getLinkCategory('product', 'cat', $type)?></div>
			<?php } ?>
			<?php if(isset($config['product'][$type]['item']) && $config['product'][$type]['item'] == true) { ?>
				<div class="form-group col-xl-2 col-lg-3 col-md-4 col-sm-4 mb-2"><p class="mb-1"><?=$config['product'][$type]['title_main_item']?></p><?=$func->getLinkCategory('product', 'item', $type)?></div>
			<?php } ?>
			<?php if(isset($config['product'][$type]['sub']) && $config['product'][$type]['sub'] == true) { ?>
				<div class="form-group col-xl-2 col-lg-3 col-md-4 col-sm-4 mb-2"><p class="mb-1"><?=$config['product'][$type]['title_main_sub']?></p><?=$func->getLinkCategory('product', 'sub', $type)?></div>
			<?php } ?>
			<?php if(isset($config['product'][$type]['brand']) && $config['product'][$type]['brand'] == true) { ?>
				<div class="form-group col-xl-2 col-lg-3 col-md-4 col-sm-4 mb-2"><p class="mb-1"><?=$config['product'][$type]['title_main_brand']?></p><?=$func->getLinkCategory('product', 'brand', $type, 'Chọn danh mục')?></div>
			<?php } ?>
	    </div>
	<?php } ?>
                                ...
                                <td class="align-middle">
                                    ...
                                    <div class="tool-action mt-2 w-clear">
                                        <?php if(isset($config['product'][$type]['color']) && $config['product'][$type]['color'] == true && $config['product'][$type]['color_product'] == true) { ?>
                                            <a class="text-primary mr-3" href="index.php?com=product&act=man_color&id_product=<?=$items[$i]['id']?>&type=<?=$type?>" title="color"><i class="far fa-eye mr-1"></i>Color</a>
                                        <?php } ?>
                                        <?php if(isset($config['product'][$type]['size']) && $config['product'][$type]['size'] == true && $config['product'][$type]['size_product'] == true) { ?>
                                            <a class="text-primary mr-3" href="index.php?com=product&act=man_size&id_product=<?=$items[$i]['id']?>&type=<?=$type?>" title="size"><i class="far fa-eye mr-1"></i>Size</a>
                                        <?php } ?>
