        ...
        <div class="row">
        	...
        	<div class="<?=$colRight?>">
			            ...
			            <div class="card-body">
		            		<div class="form-group-category row">
					            ...
					            <?php if(isset($config['product'][$type]['brand']) && $config['product'][$type]['brand'] == true) { ?>
							    	<div class="form-group col-xl-6 col-sm-4">
					                    <label class="d-block" for="id_brand"><?=$config['product'][$type]['title_main_brand']?>:</label>
							    ...
							    <?php } ?>
							    <?php if(isset($config['product'][$type]['color']) && $config['product'][$type]['color'] == true && $config['product'][$type]['color_product'] == false) { ?>
							    	<div class="form-group col-xl-6 col-sm-4">
					                    <label class="d-block" for="id_size"><?=$config['product'][$type]['title_main_color']?>:</label>
					                    <?=$func->getColor(@$item['id'])?>
					                </div>
							    <?php } ?>
							    <?php if(isset($config['product'][$type]['size']) && $config['product'][$type]['size'] == true && $config['product'][$type]['size_product'] == false) { ?>
							    	<div class="form-group col-xl-6 col-sm-4">
					                    <label class="d-block" for="id_size"><?=$config['product'][$type]['title_main_size']?>:</label>
		                ...
		                <div class="row">
			                <?php if(isset($config['product'][$type]['code']) && $config['product'][$type]['code'] == true) { ?>
			                    <div class="form-group col-md-6">
			                        <label class="d-block" for="code">Loại sản phẩm:</label>
							...
							<?php if(isset($config['product'][$type]['regular_price']) && $config['product'][$type]['regular_price'] == true) { ?>
						    	<div class="form-group col-md-6">
			                        ...
			                        <div class="input-group">
			                        	<input type="text" class="form-control format-price regular_price text-sm" name="data[regular_price]" id="regular_price" placeholder="Giá bán" value="<?=(!empty($flash->has('regular_price'))) ? $flash->get('regular_price') : @$item['regular_price']?>" <?php if(!empty($flash->has('regular_price'))){ ?>disabled<?php } ?>>
			                        	<div class="input-group-append">
			                        		<div class="input-group-text"><strong>VNĐ</strong></div>
			                        	</div>
			                        </div>
				...
				<?php if(isset($config['product'][$type]['images1']) && $config['product'][$type]['images1'] == true) { ?>
			        <div class="card card-primary card-outline text-sm">
			            <div class="card-header">
			                <h3 class="card-title">Hình ảnh 1 <?=$config['product'][$type]['title_main']?></h3>
			                <div class="card-tools">
			                	<button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
			                </div>
			            </div>
			            <div class="card-body">
	                    	<?php
	                    		...
	                    		$photoDetail1['image'] = (!empty($item) && $act != 'copy') ? $item['photo1'] : '';
	                    		$photoDetail1['dimension'] = "Width: ".$config['product'][$type]['width1']." px - Height: ".$config['product'][$type]['height1']." px (".$config['product'][$type]['img_type'].")";
			        ...
			        <div class="card card-primary card-outline text-sm">
			            ...
			            <div class="card-body">
	                    	<?php
	                    		/* Photo detail */
	                    		$photoDetail2 = array();
	                    		$photoDetail2['upload'] = UPLOAD_PRODUCT_L;
	                    		$photoDetail2['image'] = (!empty($item) && $act != 'copy') ? $item['photo2'] : '';
	                    		$photoDetail2['dimension'] = "Width: ".$config['product'][$type]['width2']." px - Height: ".$config['product'][$type]['height2']." px (".$config['product'][$type]['img_type'].")";
