        ...
        <?php if($rowDetailPhoto) { if(count($rowDetailPhoto) > 0) { ?>
            <div class="gallery-thumb-pro">
                <div class="owl-page owl-carousel owl-theme owl-pro-detail"
                    ...
                    <div>
                        <a class="thumb-pro-detail" data-zoom-id="Zoom-1" href="<?=ASSET.WATERMARK?>/product/580x580x2/<?=UPLOAD_PRODUCT_L.$rowDetail['photo']?>" title="<?=$rowDetail['name'.$lang]?>">
                            <img class="d-block w-100" src="<?=WATERMARK?>/product/580x580x2/<?=UPLOAD_PRODUCT_L.$rowDetail['photo']?>" onerror="this.src='<?=THUMBS?>/580x560x1/assets/images/noimage.png';" alt="<?=$rowDetail['name'.$lang]?>">
                        </a>
                    </div>
                    ...
                    <div>
                        <a class="thumb-pro-detail" data-zoom-id="Zoom-1" href="<?=ASSET.WATERMARK?>/product/580x580x2/<?=UPLOAD_PRODUCT_L.$v['photo']?>" title="<?=$rowDetail['name'.$lang]?>">
                            <img class="d-block w-100" src="<?=WATERMARK?>/product/580x580x1/<?=UPLOAD_PRODUCT_L.$v['photo']?>" onerror="this.src='<?=THUMBS?>/580x560x1/assets/images/noimage.png';" alt="<?=$v['name'.$lang]?>">
                        </a>
                    </div>
                    <?php } ?>
                </div>
