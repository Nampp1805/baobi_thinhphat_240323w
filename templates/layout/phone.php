    ...
    <ul>
        <li>
            <a id="goidien" href="tel:<?=preg_replace('/[^0-9]/','',$optsetting['hotline']);?>" title="title">
                <?=$func->getImage(['class' => 'd-inline-block','size-error' => '30x30x2', 'upload' => 'assets/images/', 'image' => 'icon-t1.png', 'alt' => 'Phone'])?><br>
                <span><?=goingay?></span>
            </a>
        </li>
        <li>
            <a id="nhantin" href="sms:<?=preg_replace('/[^0-9]/','',$optsetting['hotline']);?>" title="title">
                <?=$func->getImage(['class' => 'd-inline-block','size-error' => '30x30x2', 'upload' => 'assets/images/', 'image' => 'icon-t2.png', 'alt' => 'Message'])?><br>
                <span><?=nhantin?></span>
            </a>
        </li>
        <li>
            <a id="chatzalo" href="https://zalo.me/<?=preg_replace('/[^0-9]/','',$optsetting['zalo']);?>" title="title">
                <?=$func->getImage(['class' => 'd-inline-block','size-error' => '30x30x2', 'upload' => 'assets/images/', 'image' => 'icon-t3.png', 'alt' => 'Zalo'])?><br>
                <span><?=zalochat?></span>
            </a>
        </li>
        <li>
            <a id="chatfb" href="<?=$optsetting['fanpage']?>" title="title">
                <?=$func->getImage(['class' => 'd-inline-block','size-error' => '30x30x2', 'upload' => 'assets/images/', 'image' => 'icon-t4.png', 'alt' => 'Facebook'])?><br>
                <span>Facebook</span>
            </a>
        </li>
        <li>
            <a id="chiduong" href="<?=$optsetting['link_googlemaps']?>" title="title">
                <?=$func->getImage(['class' => 'd-inline-block','size-error' => '30x30x2', 'upload' => 'assets/images/', 'image' => 'chiduong.png', 'alt' => 'Chỉ đường'])?><br>
                <span><?=chiduong?></span>
            </a>
        </li>
    </ul>
