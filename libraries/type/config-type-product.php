<?php
    ...
    $config['product'][$nametype]['height'] = 560;
    ...
    $config['product'][$nametype]['size_product'] = false;
    $config['product'][$nametype]['size_regular_price'] = false;
    $config['product'][$nametype]['size_sale_price'] = false;
    $config['product'][$nametype]['size_discount'] = false;
    ...
    $config['product'][$nametype]['color_product'] = false;
    $config['product'][$nametype]['color_regular_price'] = false;
    $config['product'][$nametype]['color_sale_price'] = false;
    $config['product'][$nametype]['color_discount'] = false;
    ...
    $config['product'][$nametype]['thumb'] = '600x500x1';
    $config['product'][$nametype]['img_type'] = '.jpg|.gif|.png|.jpeg|.gif';*/
?>