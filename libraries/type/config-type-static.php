<?php
    ...
    $config['static'][$nametype]['width'] = 586;
    $config['static'][$nametype]['height'] = 465;
    $config['static'][$nametype]['images1'] = true;
    $config['static'][$nametype]['width1'] = 586;
    $config['static'][$nametype]['height1'] = 465;
    ...
    //baner
    $nametype = "baner";
    $config['static'][$nametype]['title_main'] = "Baner";
    $config['static'][$nametype]['check'] = array("hienthi" => "Hiển thị");
    $config['static'][$nametype]['images'] = true;
    ...
    $config['static'][$nametype]['images1'] = true;
    $config['static'][$nametype]['width1'] = 241;
    $config['static'][$nametype]['height1'] = 155;
    $config['static'][$nametype]['img_type'] = '.jpg|.gif|.png|.jpeg|.gif';
    $config['static'][$nametype]['file_type'] = '.doc|.docx|.pdf|.rar|.zip|.ppt|.pptx|.xls|.xlsx|.jpg|.png|.gif';
    /* Slogan */
    $nametype = "slogan";
    ...
    $config['static'][$nametype]['check'] = array();
    $config['static'][$nametype]['content'] = true;
    $config['static'][$nametype]['content_cke'] = true;
